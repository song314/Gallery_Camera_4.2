...
public class WifiCameraHostController extends PieController
    ...
    private WifiCameraHostModule mModule;
    ...
    public WifiCameraHostController(CameraActivity activity, WifiCameraHostModule module, PieRenderer pie) {
        super(activity, pie);
        mModule = module;
